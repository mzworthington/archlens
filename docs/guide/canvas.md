...
ArchLens Canvas is a workspace over **BlueprintSpec**: author in a local folder, or browse a catalog your pipeline published. Diagrams are views over a strict schema. Edit either side and the other stays in sync.
