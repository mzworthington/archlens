...
| **ArchLens CLI**    | Static analysis that discovers systems/containers/components and writes `blueprints/*.yaml`    |
...
1. Run **ArchLens CLI** against a codebase to generate blueprint YAML.
...
- [Getting started](./getting-started.md) — install ArchLens CLI, scan a repo, open the app
- [ArchLens Canvas](./canvas.md) — startup, panels, Mermaid import, externals, display toggles
- [ArchLens CLI](./cli.md) — scanners, flags, outputs
