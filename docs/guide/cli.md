...
Canvas has no IaC paste wizard. Browser lite scan and the CLI share this significance filter. See [Infrastructure from a scan](./canvas.md#infrastructure-from-a-scan).
