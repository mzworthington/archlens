...
ArchLens is built on a custom design language for architecture diagrams and product marketing. The interactive showcase lives under **Tech → Design system** in the docs sidebar at [`/design-system`](/design-system).
...
- [Interface tour & journeys](/journeys)
- [ArchLens Canvas](/guide/canvas)
