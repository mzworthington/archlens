...
| [0017](./0017-browser-structural-scan-vs-cli-forensics.md)         | Keep browser scan structural; graduate forensics to the CLI | Superseded | 2026-08-09 |
| [0018](./0018-browser-git-tracelens-via-isomorphic-git.md)         | Browser scan reads git history with isomorphic-git          | Accepted   | 2026-09-12 |
