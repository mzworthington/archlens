...
- **Zustand** store split into `uiState`, `diagramState`, `ioState` (open/save slices) and `resilienceState`.
...
| SPA routing       | Pages default SPA (no `404.html`); `_redirects` only for www→apex, asset 404s, `/index.html` 200 |
