...
Cursor Cloud agents use `.cursor/environment.json` → `bin/setup-dev-env.sh`, which installs **bun** via mise (needed for CLI build) and bootstraps [Waykit](https://github.com/mzworthington/waykit) when missing.
