  ...
  return (
    ...
    >
      ...
      >
        ...
        <ToolbarMenuPortal
          open={isOpen && Boolean(searchQuery)}
          anchorRef={containerRef}
          menuRef={resultsMenuRef}
          menuClassName={searchResultsClassName}
          placement="above-start"
          matchAnchorWidth
          minWidth={280}
          role="listbox"
        >
          <div id="workspace-node-search-results" className="p-1.5 space-y-0.5">
            {filteredNodes.length > 0 ? (
              filteredNodes.map((hit, index) => {
                const { node, diagramName, isCurrentDiagram } = hit;
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      {!isCurrentDiagram ? (
                        <div className="text-[10px] text-slate-600 truncate">in {diagramName}</div>
                      ) : null}
                    </div>
