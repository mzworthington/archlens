...
import { EntityRef as parseEntityRef } from './entityIdentity.ts';
import type { C4Level as IdentityLevel, EntityRef as EntityRefName } from './entityIdentity.ts';

export type C4Level = IdentityLevel;
export type EntityRef = EntityRefName;
export const EntityRef = parseEntityRef;
export { slugify };
