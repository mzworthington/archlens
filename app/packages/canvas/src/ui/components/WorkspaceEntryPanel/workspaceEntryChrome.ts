...
export const splitOptionShellClass =
  'flex w-full items-stretch rounded-lg border border-slate-800 bg-slate-950/60 overflow-hidden';
...
export const intentCardClass =
  'rounded-xl border border-slate-800 bg-slate-950/40 p-3 min-w-0 h-full flex flex-col';

export const intentHeadingRowClass = 'flex items-start gap-2.5 mb-3 px-0.5';
export const intentHeadingIconClass = 'w-5 h-5 text-[#00f0ff] shrink-0 mt-0.5';
export const intentHeadingTitleClass = 'text-xl font-bold tracking-tight text-white';
