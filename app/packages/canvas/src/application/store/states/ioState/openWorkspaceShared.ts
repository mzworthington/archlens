...
export type FinalizeWorkspaceOpenArgs = WorkspaceOpenSink & {
...
export async function finalizeWorkspaceOpen(args: FinalizeWorkspaceOpenArgs): Promise<boolean> {
  const {
    entryCandidate,
    resolved,
    workspaceCatalog,
